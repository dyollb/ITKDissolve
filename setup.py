...
setup(
    ...
    description=r'This is a module for the Insight Toolkit (ITK) that provides filters to dissolve regions with specified labels with their surrounding labels.',
